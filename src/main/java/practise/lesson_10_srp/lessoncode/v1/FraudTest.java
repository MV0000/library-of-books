...
import com.example.libraryofbooks.practise.lesson_10_srp.lessoncode.v1.*;
...
public class FraudTest {
    ...
    public void init() {
        List<com.example.libraryofbooks.practise.lesson_10_srp.lessoncode.v1.FraudRule> fraudRules = new ArrayList<>();
    ...
    public void isPokemonIsFraud() {
        com.example.libraryofbooks.practise.lesson_10_srp.lessoncode.v1.Trader trader = new com.example.libraryofbooks.practise.lesson_10_srp.lessoncode.v1.Trader("Pokemon", "Riga", "");
    ...
    public void isAnyButPokemonIsNotFraud() {
        com.example.libraryofbooks.practise.lesson_10_srp.lessoncode.v1.Trader trader = new com.example.libraryofbooks.practise.lesson_10_srp.lessoncode.v1.Trader("Any", "Riga", "");
        Transaction transaction = new Transaction(trader, 1000);
        boolean result = detector.isFraud(transaction);
    ...
    public void isSydneyIsFraud() {
        com.example.libraryofbooks.practise.lesson_10_srp.lessoncode.v1.Trader trader = new com.example.libraryofbooks.practise.lesson_10_srp.lessoncode.v1.Trader("Someone", "Sydney", "");
        Transaction transaction = new Transaction(trader, 1000);
    ...
    public void isCountryIsFraud() {
        com.example.libraryofbooks.practise.lesson_10_srp.lessoncode.v1.Trader trader = new com.example.libraryofbooks.practise.lesson_10_srp.lessoncode.v1.Trader("Someone", "I dont know the name", "Jamaica");
        Transaction transaction = new Transaction(trader, 1000);
    ...
    public void isCountryIsNotFraud() {
        com.example.libraryofbooks.practise.lesson_10_srp.lessoncode.v1.Trader trader = new Trader("Someone", "Tokyo", "Japan");
        Transaction transaction = new Transaction(trader, 1000);
