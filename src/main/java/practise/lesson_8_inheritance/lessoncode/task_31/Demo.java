...
import com.example.libraryofbooks.practise.lesson_8_inheritance.lessoncode.task_31.Library;
...
public class Demo {
    ...
    public static void main(String[] args) {
        ...
        library.addBook(new com.example.libraryofbooks.practise.lesson_8_inheritance.lessoncode.task_31.Book(1L, "AAA", "BBB", false));
        library.addBook(new com.example.libraryofbooks.practise.lesson_8_inheritance.lessoncode.task_31.Book(2L, "CCC", "TTT", false));
        library.addBook(new com.example.libraryofbooks.practise.lesson_8_inheritance.lessoncode.task_31.Book(3L, "DDD", "RRR", false));

        Reader reader = new Reader("123", "Alex", 21);
        ReaderCard readerCard = new ReaderCard(reader, new ArrayList<>(), new ArrayList<>());

        com.example.libraryofbooks.practise.lesson_8_inheritance.lessoncode.task_31.Book bookToTake = new com.example.libraryofbooks.practise.lesson_8_inheritance.lessoncode.task_31.Book(2L, "CCC", "TTT", false);
